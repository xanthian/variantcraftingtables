...
public class RecipeGenerator extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        offer2x2CompactingRecipe(withConditions(exporter,DefaultResourceConditions.allModsLoaded("regions_unexplored")),RecipeCategory.MISC, RegionsUnexplored.RU_CHERRY_CRAFTING_TABLE, Registries.ITEM.get(new Identifier("regions_unexplored:cherry_planks")));
        ...
        offer2x2CompactingRecipe(withConditions(exporter,DefaultResourceConditions.allModsLoaded("regions_unexplored")),RecipeCategory.MISC, RegionsUnexplored.RU_SCULKWOOD_CRAFTING_TABLE, Registries.ITEM.get(new Identifier("regions_unexplored:sculkwood_planks")));
