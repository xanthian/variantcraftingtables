...
public class NaturesSpirit {
    ...
    public static Block NS_MAHOGANY_CRAFTING_TABLE;
    ...
    public static Block NS_SAXAUL_CRAFTING_TABLE;
    ...
    public static void registerTables() {
        ...
        NS_MAHOGANY_CRAFTING_TABLE = registerCraftingTable("ns_mahogany_crafting_table");
        ...
        NS_SAXAUL_CRAFTING_TABLE = registerCraftingTable("ns_saxaul_crafting_table");
